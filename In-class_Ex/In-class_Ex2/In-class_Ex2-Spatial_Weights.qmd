...
To plot the content of the data table, you can either display the output data frame on RStudio data ploter or by printing out the first ten records by using the code chunk below.
