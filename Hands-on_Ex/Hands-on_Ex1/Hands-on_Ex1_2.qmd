---
title: "Hands on 1b - Choropleth Mapping with R"
...
-   *tmap_mode()* with "plot" option is used to produce a static map. For interactive mode, "plot" option should be used.
...
up them into data ranges or classes.
...
> For example: quantile claissfications is not appropriate for highly skewed distributions like our scenario. For example: pretty and equal claissfications however, might not differentiate enough to show any useful information
...
> Ans: We are able to visualise the maps at a higher level of granularity as the number of classes increases. It provides more information for us to work with.
